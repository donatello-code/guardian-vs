...
description: "Build a working todo app with Guardian VS and learn the core workflow."
---

This tutorial walks you through building a todo app with Guardian VS from scratch. Along the way, you'll learn how to give tasks, approve changes, iterate on your work, and recover from mistakes.
...
1. **Guardian VS proposes a file change.** You'll see a section in the chat showing the file path (e.g., `index.html`) and the code Guardian VS wants to write. New lines of code are highlighted in **green**.
