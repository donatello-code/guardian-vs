---
title: "All Guardian VS Tools"
sidebarTitle: "All Guardian VS Tools"
description: "Complete reference for Guardian VS's built-in tools and capabilities."
---

Guardian VS has access to a set of tools for various tasks. This reference covers all available tools and how to use them.

## What Can Guardian VS Do?
...
MCP tools extend Guardian VS's capabilities through external integrations. See [MCP documentation](/mcp/mcp-overview) for details.
...
1. Guardian VS proposes creating a new task with summarized context
...
Type `/newtask` in chat to manually trigger this process. Guardian VS will:
