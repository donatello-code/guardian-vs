/**
 * Failure classification system for Guardian evaluations
 *
...
export class FailureClassifier {
	...
	constructor(patternsPath?: string) {
		const defaultPath = path.join(__dirname, "../patterns/guardian-failures.yaml")
	 ...
	 * @param logs Full log text (e.g., guardian.txt content)
