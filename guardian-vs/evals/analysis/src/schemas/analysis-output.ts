/**
 * Type definitions for Guardian Analysis Framework output
...
export interface AnalysisMetadata {
	...
	agent: string // Agent name (e.g., "guardian-cli")
...
export type FailureCategory =
	| "provider_bug" // Guardian integration bugs (Gemini #7974, Claude #7998)
