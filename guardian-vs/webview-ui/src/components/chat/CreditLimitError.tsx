...
const DEFAULT_BUY_CREDITS_URL = {
	USER: "https://app.guardian.bot/dashboard/account?tab=credits&redirect=true",
	ORG: "https://app.guardian.bot/dashboard/organization?tab=credits&redirect=true",
}
...
const CreditLimitError: React.FC<CreditLimitErrorProps> = ({
	...
	const { activeOrganization } = useGuardianAuth()
