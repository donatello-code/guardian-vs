...
const createTextMessage = (ts: number, text: string): GuardianMessage => ({
	type: "say",
	say: "text",
	text,
	ts,
...
const createToolMessage = (ts: number, tool: string): GuardianMessage => ({
	type: "say",
	say: "tool",
...
const createReasoningMessage = (ts: number, text: string): GuardianMessage => ({
	type: "say",
	say: "reasoning",
	text,
	ts,
