 ...
 */
export function useIdleIndicator(scrollContainerRef: React.RefObject<HTMLDivElement>, guardianMessages: GuardianMessage[]): boolean {
	...
	useEffect(() => {
		...
		const isTaskComplete = guardianMessages.some(
	...
	}, [scrollContainerRef, guardianMessages])
