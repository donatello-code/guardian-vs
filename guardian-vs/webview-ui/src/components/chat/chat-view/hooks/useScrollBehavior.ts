...
export function useScrollBehavior(
	...
	visibleMessages: GuardianMessage[],
	...
	const [scrolledPastUserMessage, setScrolledPastUserMessage] = useState<GuardianMessage | null>(null)
	...
	const checkScrolledPastUserMessage = useCallback(() => {
		...
		let mostRecentScrolledPast: GuardianMessage | null = null
