...
import { SapAiCoreModelDeployment } from "@shared/proto/index.guardian"
...
const SapAiCoreModelPicker: React.FC<SapAiCoreModelPickerProps> = ({
	...
	const categorizedModels = useMemo(() => {
		...
		// Models that are both deployed AND supported in Guardian
		...
		// Models that are supported in Guardian but NOT deployed
