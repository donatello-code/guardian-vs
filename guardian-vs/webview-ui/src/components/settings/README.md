...
This directory contains the refactored API Options components for the Guardian extension. The refactoring aims to improve maintainability, code organization, and reduce complexity by separating provider-specific code into modular components.
...
│   ├── GuardianProvider.tsx       # Guardian configuration
