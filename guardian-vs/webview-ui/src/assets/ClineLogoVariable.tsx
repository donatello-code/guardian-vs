...
/**
 * GuardianLogoVariable component renders the Guardian logo with automatic theme adaptation
 ...
 * @returns {JSX.Element} SVG Guardian logo that adapts to VS Code themes and environment
 */
const GuardianLogoVariable = (props: SVGProps<SVGSVGElement> & { environment?: Environment }) => {
...
export default GuardianLogoVariable
