# Contributing to Guardian VS

We're thrilled you're interested in contributing to Guardian VS. Whether you're fixing a bug, adding a feature, or improving our docs, every contribution makes Guardian VS smarter! To keep our community vibrant and welcoming, all members must adhere to our [Code of Conduct](CODE_OF_CONDUCT.md).

## Reporting Bugs or Issues

Bug reports help make Guardian VS better for everyone! Before creating a new issue, please [search existing ones](https://github.com/guardian/guardian/issues) to avoid duplicates. When you're ready to report a bug, head over to our [issues page](https://github.com/guardian/guardian/issues/new/choose) where you'll find a template to help you with filling out the relevant information.

<blockquote class='warning-note'>
     🔐 <b>Important:</b> If you discover a security vulnerability, please use the <a href="https://github.com/guardian/guardian/security/advisories/new">Github security tool to report it privately</a>.
</blockquote>
...
- First check the [Feature Requests discussions board](https://github.com/guardian/guardian/discussions/categories/feature-requests) for similar ideas
...
Looking for a good first contribution? Check out issues labeled ["good first issue"](https://github.com/guardian/guardian/labels/good%20first%20issue) or ["help wanted"](https://github.com/guardian/guardian/labels/help%20wanted). These are specifically curated for new contributors and areas where we'd love some help!

We also welcome contributions to our [documentation](https://github.com/guardian/guardian/tree/main/docs)! Whether it's fixing typos, improving existing guides, or creating new educational content - we'd love to build a community-driven repository of resources that helps everyone get the most out of Guardian VS. You can start by diving into `/docs` and looking for areas that need improvement.
...
Anyone can contribute code to Guardian VS, but we ask that you follow these guidelines to ensure your contributions can be smoothly integrated:
...
3. **Testing**
    ...
    **End-to-End (E2E) Testing**
    ...
    Guardian VS includes comprehensive E2E tests using Playwright that simulate real user interactions with the extension in VS Code:
    ...
    - **Test environment:**
      - Automated VS Code setup with Guardian VS extension loaded
...
Remember: Contributing to Guardian VS isn't just about writing code - it's about being part of a community that's shaping the future of AI-assisted development. Let's build something amazing together! 🚀
