...
/**
 * Combines API request start and finish messages in an array of GuardianMessages.
 *
 ...
 * @returns A new array of GuardianMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: GuardianMessage[]): GuardianMessage[] {
	const combinedApiRequests: GuardianMessage[] = []
