 ...
 * ## Proxy Support
 *
 * Guardian uses platform-specific fetch implementations to handle proxy
 * configuration:
 ...
 * 3. View logs: Check ~/.guardian/guardian-core-service.log for network-related
 *    failures.
