...
/**
 * Calculates API metrics from an array of GuardianMessages.
 *
 ...
 */
export function getApiMetrics(messages: GuardianMessage[]): ApiMetrics {
 ...
 */
export function getLastApiReqTotalTokens(messages: GuardianMessage[]): number {
