 ...
 * @returns A new array of GuardianMessage objects with error_retry sequences consolidated.
 *
 * @example
 ...
 */
export function combineErrorRetryMessages(messages: GuardianMessage[]): GuardianMessage[] {
