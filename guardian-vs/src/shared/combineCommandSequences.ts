...
/**
 * Combines sequences of command and command_output messages in an array of GuardianMessages.
 *
 * This function processes an array of GuardianMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of GuardianMessage objects to process.
 * @returns A new array of GuardianMessage objects with command sequences combined.
 *
 * @example
 ...
 */
export function combineCommandSequences(messages: GuardianMessage[]): GuardianMessage[] {
	const combinedCommands: GuardianMessage[] = []
