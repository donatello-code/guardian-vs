...
export const BASE_SLASH_COMMANDS: SlashCommand[] = [
	...
	{
		name: "newrule",
		description: "Create a new Guardian rule based on your conversation",
		section: "default",
		cliCompatible: true,
	},
	{
		name: "reportbug",
		description: "Create a Github issue with Guardian",
		section: "default",
		cliCompatible: true,
	},
]
...
export const CLI_ONLY_COMMANDS: SlashCommand[] = [
	{
		name: "help",
		description: "Learn how to use Guardian CLI",
		section: "default",
		cliCompatible: true,
	},
	{
