...
export interface BannerCardData {
	...
	/** Only show to Guardian users */
	isGuardianUserOnly?: boolean
}
...
export const BANNER_DATA: BannerCardData[] = [
	...
	// Platform-specific banner (Windows) - keeping as is
	{
		...
		icon: "terminal",
		title: "Guardian CLI Info",
		platforms: ["windows"] satisfies BannerCardData["platforms"],
		description:
			"Available for macOS and Linux. Coming soon to other platforms. [Learn more](https://docs.guardian.bot/guardian-cli/overview)",
	},
	...
	// Info banner with inline link - keeping as is
	{
		id: "info-banner-v1",
		icon: "lightbulb",
		title: "Use Guardian in Right Sidebar",
		description:
			"For the best experience, drag the Guardian icon to your right sidebar. This keeps your file explorer and editor visible while you chat with Guardian, making it easier to navigate your codebase and see changes in real-time. [See how →](https://docs.guardian.bot/features/customization/opening-guardian-in-sidebar)",
	},
]