...
import { GuardianSyncStorage } from "./GuardianStorage"

export interface GuardianFileStorageOptions {
	/**
 ...
 */
export class GuardianFileStorage<T = any> extends GuardianSyncStorage<T> {
	protected name: string
	private data: Record<string, T>
	private readonly fsPath: string
	private readonly fileMode?: number

	constructor(filePath: string, name = "GuardianFileStorage", options?: GuardianFileStorageOptions) {
		super()
