...
export const addSelectedCodeToGuardianWebview = async (_page: Page) => {
	...
	const addToGuardian = _page.getByText(/Add to Guardian/i)
	await addToGuardian.waitFor({ state: "visible" })
