...
import type { GuardianAPI } from "../exports/guardian"
import { setVscodeHostProviderMock } from "./host-provider-test-utils"

describe("GuardianAPI Core Functionality", () => {
	let api: GuardianAPI
	...
	beforeEach(async () => {
		...
		// Create a mock controller that matches what the real createGuardianAPI expects
		...
		// Create API instance
		api = createGuardianAPI(mockController)
	})
