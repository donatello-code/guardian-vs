 ...
 * that data to the shared file-backed stores in ~/.guardian/data/ so all platforms
 ...
 *   globalStorageFsPath is still the VSCode-managed path (not ~/.guardian/data/),
 ...
 *   to ~/.guardian/data/ so that tasks created in VSCode are visible in CLI/JetBrains
