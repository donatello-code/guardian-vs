 ...
 * GitOperations Class
 *
 * Handles git-specific operations for Guardian's Checkpoints system.
 *
...
export class GitOperations {
	...
	public async initShadowGit(gitPath: string, cwd: string, taskId: string): Promise<string> {
		...
		await git.addConfig("user.name", "Guardian Checkpoint")
		await git.addConfig("user.email", "checkpoint@guardian.bot")
