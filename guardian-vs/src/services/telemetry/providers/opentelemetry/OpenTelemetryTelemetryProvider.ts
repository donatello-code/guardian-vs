...
import type { GuardianAccountUserInfo } from "../../../auth/AuthService"
...
export class OpenTelemetryTelemetryProvider implements ITelemetryProvider {
	...
	constructor(
		...
		if (meterProvider) {
			this.meter = meterProvider.getMeter("guardian")
			this.meterProvider = meterProvider
		}

		if (loggerProvider) {
			this.logger = loggerProvider.getLogger("guardian")
	...
	public identifyUser(userInfo: GuardianAccountUserInfo, properties: TelemetryProperties = {}): void {
	 ...
	 */
	private buildUserAttributes(userInfo: GuardianAccountUserInfo, properties: TelemetryProperties = {}): Record<string, string> {
