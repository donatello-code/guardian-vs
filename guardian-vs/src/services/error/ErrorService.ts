...
/**
 * ErrorService handles error logging and tracking for the Guardian extension
...
export class ErrorService {
	...
	public toGuardianError(rawError: unknown, modelId?: string, providerId?: string): GuardianError {
		const transformed = GuardianError.transform(rawError, modelId, providerId)
