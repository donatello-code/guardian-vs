...
import type { GuardianError } from "../GuardianError"
...
export interface IErrorProvider {
	 ...
	 * @param error The error to log (Error or GuardianError)
	 * @param properties Optional additional properties to attach
	 */
	logException(error: Error | GuardianError, properties?: Record<string, unknown>): void
