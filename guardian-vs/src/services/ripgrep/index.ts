...
export async function regexSearchFiles(
	...
	// Filter results using GuardianIgnoreController if provided
	const filteredResults = guardianIgnoreController
		? results.filter((result) => guardianIgnoreController.validateAccess(result.filePath))
		: results
