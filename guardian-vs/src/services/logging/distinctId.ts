 ...
 */
export const _GENERATED_MACHINE_ID_KEY = "guardian.generatedMachineId"
 ...
 * This is updated to Guardian User ID when authenticated.
 */
 ...
 * If authenticated, this will be the Guardian User ID.
