...
import type { GuardianFileStorage } from "@shared/storage/GuardianFileStorage"
import {
	applyTransform,
...
import { GuardianMemento } from "@/shared/storage"
...
/**
 * Read secrets from a GuardianFileStorage instance.
 */
export function readSecretsFromStorage(store: GuardianFileStorage<string>): Secrets {
...
/**
 * Read workspace state from a GuardianFileStorage instance.
 */
export function readWorkspaceStateFromStorage(store: GuardianFileStorage): LocalState {
...
/**
 * Read global state from a GuardianFileStorage instance.
 */
export async function readGlobalStateFromStorage(store: GuardianMemento): Promise<GlobalStateAndSettings> {
	try {
