...
export async function getUserInstructions(variant: PromptVariant, context: SystemPromptContext): Promise<string | undefined> {
	const customInstructions = buildUserInstructions(
		context.globalGuardianRulesFileInstructions,
		context.localGuardianRulesFileInstructions,
		...
		context.guardianIgnoreInstructions,
...
function buildUserInstructions(
	globalGuardianRulesFileInstructions?: string,
	localGuardianRulesFileInstructions?: string,
	localCursorRulesFileInstructions?: string,
	localCursorRulesDirInstructions?: string,
	localWindsurfRulesFileInstructions?: string,
	localAgentsRulesFileInstructions?: string,
	guardianIgnoreInstructions?: string,
	...
	if (globalGuardianRulesFileInstructions) {
		customInstructions.push(globalGuardianRulesFileInstructions)
	}
	if (localGuardianRulesFileInstructions) {
		customInstructions.push(localGuardianRulesFileInstructions)
	}
	...
	if (guardianIgnoreInstructions) {
		customInstructions.push(guardianIgnoreInstructions)
	}
