...
export interface PromptVariant {
	...
	// Tool configuration
	readonly tools?: readonly GuardianDefaultTool[] // Ordered list of tools to include
	readonly toolOverrides?: Readonly<Partial<Record<GuardianDefaultTool, ConfigOverride>>> // Tool customizations
}
...
export interface MutablePromptVariant {
	...
	tools?: GuardianDefaultTool[]
	toolOverrides?: Partial<Record<GuardianDefaultTool, ConfigOverride>>
}
...
export interface PromptConfig {
	...
	readonly tools?: readonly GuardianToolSpec[]
...
export interface SystemPromptContext {
	...
	readonly globalGuardianRulesFileInstructions?: string
	readonly localGuardianRulesFileInstructions?: string
	...
	readonly guardianIgnoreInstructions?: string
	...
	readonly guardianWebToolsEnabled?: boolean
...
export type ToolKey = keyof typeof GuardianDefaultTool
export type ToolValue = (typeof GuardianDefaultTool)[ToolKey]
...
export function isValidGuardianDefaultTool(tool: string): tool is GuardianDefaultTool {
	return Object.values(GuardianDefaultTool).includes(tool as GuardianDefaultTool)
}
...
export interface VariantBuilder {
	...
	tools(...tools: GuardianDefaultTool[]): this
	overrideTool(tool: GuardianDefaultTool, override: ConfigOverride): this
