...
const baseContext: SystemPromptContext = {
	...
	focusChainSettings: { enabled: true, remindGuardianInterval: 6 },
	browserSettings: { viewport: { width: 1280, height: 720 } },
	globalGuardianRulesFileInstructions: "Follow global rules",
	localGuardianRulesFileInstructions: "Follow local rules",
...
const contextVariations: Array<{ name: string; override: Partial<SystemPromptContext> }> = [
	...
	{ name: "no-focus-chain", override: { focusChainSettings: { enabled: false, remindGuardianInterval: 0 } } },
]
...
const modelTestCases = [
	...
	{ family: ModelFamily.DEVSTRAL, modelId: "devstral", providerId: "guardian" },
	...
	{ family: ModelFamily.NATIVE_NEXT_GEN, modelId: "claude-4-5-sonnet", providerId: "guardian" },
