import { GuardianDefaultTool, toolUseNames } from "@shared/tools"
...
// parseAssistantmessageV1 removed in https://github.com/guardian/guardian/pull/5425
...
export function parseAssistantMessageV2(assistantMessage: string): AssistantMessageContent[] {
	...
	const toolUseOpenTags = new Map<string, GuardianDefaultTool>()
