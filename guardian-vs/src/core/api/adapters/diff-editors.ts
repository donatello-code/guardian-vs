 ...
 */
export function convertApplyPatchToolCalls(messages: Array<GuardianStorageMessage>): Array<GuardianStorageMessage> {
 ...
 */
export function convertWriteToFileToolCalls(messages: Array<GuardianStorageMessage>): Array<GuardianStorageMessage> {
	// Map to track tool_use_id to converted tool info and original input
