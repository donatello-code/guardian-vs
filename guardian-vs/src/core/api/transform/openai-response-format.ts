...
/**
 * Converts an array of GuardianStorageMessage objects (extension of Anthropic format) to a ResponseInput array to use with OpenAI's Responses API.
 *
 ...
 *
 * @param messages - Array of GuardianStorageMessage objects to be converted
...
export function convertToOpenAIResponsesInput(
	_messages: GuardianStorageMessage[],
