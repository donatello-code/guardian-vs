		...
		if (!this.client) {
			...
			try {
				this.client = createOpenAIClient({
					...
					defaultHeaders: {
						"HTTP-Referer": "https://guardian.bot", // Optional, for including your app on openrouter.ai rankings.
						"X-Title": "Guardian VS", // Optional. Shows in rankings on openrouter.ai.
					},
				})
			} catch (error: any) {
