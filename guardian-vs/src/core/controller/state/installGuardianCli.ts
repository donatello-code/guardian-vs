import { Empty, EmptyRequest } from "@shared/proto/guardian/common"
...
/**
 * Handles the installation of the Guardian CLI tool
 * @param controller The controller instance
 * @param _request The empty request
 * @returns Empty response
 */
export async function installGuardianCli(_controller: Controller, _request: EmptyRequest): Promise<Empty> {
	const installCommand = "npm install -g guardian"
