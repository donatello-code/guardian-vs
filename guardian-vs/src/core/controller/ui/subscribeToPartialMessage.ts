...
import { GuardianMessage } from "@shared/proto/guardian/ui"
import { Logger } from "@/shared/services/Logger"
import { getRequestRegistry, StreamingResponseHandler } from "../grpc-handler"
import { Controller } from "../index"

// Keep track of active partial message subscriptions (gRPC streams)
const activePartialMessageSubscriptions = new Set<StreamingResponseHandler<GuardianMessage>>()

// Keep track of callback-based subscriptions (for CLI and other non-gRPC consumers)
export type PartialMessageCallback = (message: GuardianMessage) => void
...
export async function subscribeToPartialMessage(
	...
	responseStream: StreamingResponseHandler<GuardianMessage>,
	requestId?: string,
): Promise<void> {
 ...
 * @param partialMessage The GuardianMessage to send
 */
export async function sendPartialMessageEvent(partialMessage: GuardianMessage): Promise<void> {
