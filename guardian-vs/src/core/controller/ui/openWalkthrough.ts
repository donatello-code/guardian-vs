import type { EmptyRequest } from "@shared/proto/guardian/common"
...
/**
 * Opens the Guardian walkthrough in VSCode
...
export async function openWalkthrough(_controller: Controller, _request: EmptyRequest): Promise<Empty> {
	try {
		await vscode.commands.executeCommand(
			...
			`saoudrizwan.${ExtensionRegistryInfo.name}#GuardianWalkthrough`,
		)
