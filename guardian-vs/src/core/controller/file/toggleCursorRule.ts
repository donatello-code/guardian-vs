import type { ToggleCursorRuleRequest } from "@shared/proto/guardian/file"
 ...
 */
export async function toggleCursorRule(controller: Controller, request: ToggleCursorRuleRequest): Promise<GuardianRulesToggles> {
