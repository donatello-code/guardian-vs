import type { ToggleAgentsRuleRequest } from "@shared/proto/guardian/file"
import { GuardianRulesToggles } from "@shared/proto/guardian/file"
 ...
 */
export async function toggleAgentsRule(controller: Controller, request: ToggleAgentsRuleRequest): Promise<GuardianRulesToggles> {
	...
	return GuardianRulesToggles.create({
