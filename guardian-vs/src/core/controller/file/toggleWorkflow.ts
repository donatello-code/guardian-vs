import { GuardianRulesToggles, RuleScope, ToggleWorkflowRequest } from "@shared/proto/guardian/file"
 ...
 */
export async function toggleWorkflow(controller: Controller, request: ToggleWorkflowRequest): Promise<GuardianRulesToggles> {
	...
	return GuardianRulesToggles.create({ toggles: toggles })
}
