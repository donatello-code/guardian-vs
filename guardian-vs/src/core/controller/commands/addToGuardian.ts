...
// 'Add to Guardian' context menu in editor and code action
// Inserts the selected code into the chat.
export async function addToGuardian(controller: Controller, request: CommandContext, notebookContext?: string): Promise<Empty> {
	...
	Logger.log("addToGuardian", request.selectedText, filePath, request.language)
