...
# 
# Input: { taskId, taskStart: { task: string }, guardianVersion, timestamp, ... }
...
# 
# Input: { taskId, taskResume: { task: string }, guardianVersion, timestamp, ... }
# Output: { cancel: boolean, contextModification?: string, errorMessage?: string }
# 
# Use cases:
...
# 
# Input: { taskId, taskCancel: { task: string }, guardianVersion, timestamp, ... }
# Output: { cancel: boolean, contextModification?: string, errorMessage?: string }
# 
# Use cases:
...
# 
# Input: { taskId, taskComplete: { task: string }, guardianVersion, timestamp, ... }
# Output: { cancel: boolean, contextModification?: string, errorMessage?: string }
# 
# Use cases:
...
# 
# Executes when the user submits a prompt to Guardian.
# 
# Input: { taskId, userPromptSubmit: { prompt: string }, guardianVersion, timestamp, ... }
# Output: { cancel: boolean, contextModification?: string, errorMessage?: string }
# 
# Use cases:
